    ...
    setup() {
        ...
        const menus = ref([
            ...
            },
            {
                key: 'test1',
                label: (key) => {
                    return backDisabled ? '按钮不可用' : '按钮可用'
                },
                click: () => {
                    backDisabled = true
                },
            ...
            },
            {
                key: 'test2',
                label: (key) => {
                    return backDisabled ? '激活上一个菜单' : '请点击上面的按钮'
                },
                click: () => {
                    backDisabled = false
                    return true
        ...
        setTimeout(() => {
            ...
            menus.value[9].children[8].label = '123'
            menus.value[9].children[9].children[2].children[1].label = '123'
        }, 10000);
